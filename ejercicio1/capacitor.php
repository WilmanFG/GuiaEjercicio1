...
<!-- <link rel="stylesheet" href="css/edades1.css" /> -->
...
case "serie":
echo "<form name='frmedades' action='capacitorserie.php' method='POST'>";
echo "<fieldset>";
echo "<legend><span>Ingrese el valor de los capacitores:</span></legend>";
echo "<ul>";
echo "<li>";
echo "<label for='edad'>Valores:</label>";
echo "<div class=\"campo\">";
echo "<input type='number' name='edad' step='0.1' id='edad' maxlength='60'>";
...
break;
case "paralelo":
echo "<form name='frmedades' action='capacitorparalelo.php' method='POST'>";
echo "<fieldset>";
echo "<legend><span>Ingrese el valor de los capacitores:</span></legend>";
echo "<ul>";
echo "<li>";
